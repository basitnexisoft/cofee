...
import img1 from '../assets/img/Review1.webp'
import img2 from '../assets/img/Review2.webp'
import img3 from '../assets/img/Review3.png'

const Review = () => {
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 bg-backgroundColor">
        <h1 className=" font-semibold text-center text-4xl lg:-14 mt-24">Customer's Reviews</h1>
